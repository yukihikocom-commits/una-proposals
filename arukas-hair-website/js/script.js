...
(function () {
  var translations = {
    ja: {
      nav_services:"サービス", nav_gallery:"施術例", nav_story:"当店について", nav_reviews:"口コミ", nav_visit:"アクセス", nav_faq:"よくある質問", nav_book:"予約",
      hero_kicker:"テキサス州プレイノ · 日本人ヘアサロン",
      hero_h1:"アジアンヘアを、<strong>日本人の手</strong>で。",
      hero_desc:"縮毛矯正、バレイヤージュ、丁寧なカット。アジアンヘアを知り尽くした、日本人スタッフだけのサロンです。",
      ...
      gal_eyebrow:"施術例", gal_title:"これまでの仕上がり",
      ...
      gal_cta_btn:"ご予約はこちら",
      story_eyebrow:"当店について", story_title:"プレイノの街で、日本のサロンを",
      ...
      rev_eyebrow:"お客様の声", rev_title:"プレイノで愛される、Google 4.4★",
      rev1:"「希望をきちんと聞いて、ぴったりに仕上げてくれました。今の髪が大好きです。」",
      rev2:"「1年以上通っています。他の人には任せられません。とても親しみやすいお店です。」",
      rev3:"「アジアンヘアを本当に扱えるサロンを探しているなら、ここです。」",
      ...
      f_name:"お名前", f_email:"メール", f_phone:"電話番号（任意）", f_service:"メニュー", f_message:"メッセージ", f_submit:"送信する",
